...
func (_m *MockConnector) Connect(name string, opts ConnectOpts) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ConnectOpts) (string, error)); ok {
		return rf(name, opts)
	}
	if rf, ok := ret.Get(0).(func(string, ConnectOpts) string); ok {
		r0 = rf(name, opts)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(string, ConnectOpts) error); ok {
		r1 = rf(name, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockConnector_Connect_Call) Run(run func(name string, opts ConnectOpts)) *MockConnector_Connect_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(ConnectOpts))
	})
	return _c
}
...
func (_c *MockConnector_Connect_Call) RunAndReturn(run func(string, ConnectOpts) (string, error)) *MockConnector_Connect_Call {
	_c.Call.Return(run)
	return _c
}
